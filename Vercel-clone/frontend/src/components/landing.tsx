      ...
      {deployed && <Card className="w-full max-w-md mt-8">
        ...
        <CardContent>
          <div className="space-y-2">
            ...
            <Input id="deployed-url" readOnly type="url" value={`http://${uploadId}.dev.vercel2003.com:3001/index.html`} />
          </div>
          <br />
          <Button className="w-full" variant="outline">
            <a href={`http://${uploadId}.dev.vercel2003.com:3001/index.html`} target="_blank">
              Visit Website
            </a>
          </Button>
        </CardContent>
